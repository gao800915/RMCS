...
class OIOPIWheelLegInfantry
    : public rmcs_executor::Component
    , public rclcpp::Node {
public:
    OIOPIWheelLegInfantry()
        : Node{get_component_name(), rclcpp::NodeOptions{}.automatically_declare_parameters_from_overrides(true)}
        , logger_(get_logger())
        , infantry_command_(
              create_partner_component<OIOPIWheelLegInfantryCommand>(
    ...
    class OIOPIWheelLegInfantryCommand : public rmcs_executor::Component {
    public:
        explicit OIOPIWheelLegInfantryCommand(OIOPIWheelLegInfantry& infantry)
            : infantry_(infantry) {}

        void update() override { infantry_.command_update(); }

        OIOPIWheelLegInfantry& infantry_;
    };

    
    class BottomBoard final : private librmcs::client::CBoard {
    public:
        friend class OIOPIWheelLegInfantry;
        explicit BottomBoard(
            OIOPIWheelLegInfantry& infantry, OIOPIWheelLegInfantryCommand& infantry_command, int usb_pid = -1)
    ...
    std::shared_ptr<OIOPIWheelLegInfantryCommand> infantry_command_;
...
PLUGINLIB_EXPORT_CLASS(rmcs_core::hardware::OIOPIWheelLegInfantry, rmcs_executor::Component)